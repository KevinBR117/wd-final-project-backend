...
class PersonalityTestByTypeExport implements
    WithHeadings,
    FromQuery,
    ShouldAutoSize,
    WithMapping,
    ...
    WithCustomStartCell
{
    ...
    function __construct($personalityType)
    {
    ...
    {
        $data = PersonalityTest::query()->with('user')->where('personalityTypeObtained', $this->personalityType);
        return $data;
    }
